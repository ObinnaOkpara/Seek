    ...
    public partial class MainWindow
    {
        ...
        private void mainWindow_Closing(object sender, CancelEventArgs e)
        {
            ...
            if (Settings.Default.ConfirmExit)
            {
                ...
                MessageBoxResult result = Xceed.Wpf.Toolkit.MessageBox.Show(message, "Seek", MessageBoxButton.YesNo, MessageBoxImage.Question);
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            else { Xceed.Wpf.Toolkit.MessageBox.Show("Select Download Items to Start."); }
        }
        ...
        private void btnStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Xceed.Wpf.Toolkit.MessageBox.Show("Select Download Items to Start.");
            }
        }
        ...
        private void btnPause_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Xceed.Wpf.Toolkit.MessageBox.Show("Select Download Items to Pause.");
            }
        }
        ...
        private void BtnIndexDownload_Click(object sender, RoutedEventArgs e)
        {
            IndexDownload indexDownload = new IndexDownload(this);
            indexDownload.ShowDialog();
        }

        private void BtnSeriesDownload_Click(object sender, RoutedEventArgs e)
        {
            SeriesDownload sd = new SeriesDownload(this);
            sd.ShowDialog();
        }
        #endregion
    }
