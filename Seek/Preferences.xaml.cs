...
namespace Seek
{
    public partial class Preferences : Window
    {
        ...
        public Preferences(bool openLimitsTab)
        {
            ...
            if (registryKey.GetValue("Seek") == null || !Settings.Default.StartOnSystemStartup)
            {
        ...
        private void SaveSettings()
        {
            ...
            if (registryKey != null)
            {
                if (Settings.Default.StartOnSystemStartup)
                {
                    ...
                    registryKey.SetValue("Seek", "\"" + Assembly.GetExecutingAssembly().Location + "\"");
                }
                else
                {
                    // Delete the value from the Registry to disable application start on system startup
                    registryKey.DeleteValue("Seek", false);
                }
            }
